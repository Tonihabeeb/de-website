...
const projects: Project[] = [
  {
    ...
    status: 'planned',
    description:
      'Major KPP power plant planned for northern Iraq, providing clean energy to the Kurdistan region.',
    progress: 0,
  },
  {
    id: 'soran',
    ...
    status: 'planned',
    description:
      'Strategic KPP installation serving the Soran district with continuous renewable power.',
    progress: 0,
  },
  {
    id: 'raparin',
    ...
    status: 'construction',
    description:
      'KPP power plant under construction, bringing clean energy to the Raparin region.',
    progress: 35,
  },
  {
    id: 'garmian',
    ...
    coordinates: [34.75, 45.5],
    capacity: '50 MW',
    status: 'planned',
    description:
      'Planned KPP facility to serve the Garmian region with sustainable power generation.',
    progress: 0,
  },
];
