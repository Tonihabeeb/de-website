...
export default function Navbar() {
  ...
  // Detect scroll position to determine if navbar is over hero section
  useEffect(() => {
    const handleScroll = () => {
      if (isHomePage) {
        const scrollY = window.scrollY;
        const heroHeight = window.innerHeight; // Hero section is full screen
  ...
  return (
    <ClientOnly
      fallback={
        <nav className='sticky top-0 z-50 transition-all duration-300 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm'>
      ...
      >
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-16'>
            ...
            >
              <Image
                src={isHomePage && isOverHero ? '/logo-white.svg' : '/logo.svg'}
                alt='Deep Engineering company logo'
                height={40}
                width={120}
                priority
                      ...
                      {(item.name === 'About'
                        ...
                        : item.name === 'Technology'
                          ...
                          : item.name === 'Services'
                            ...
                            : teamDropdownOpen) && (
                        <div
                          className='absolute top-full left-0 mt-2 w-64 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200/50 py-2 z-20'
                          onMouseEnter={() => {
                            if (item.name === 'About') {
                              setAboutDropdownOpen(true);
                            } else if (item.name === 'Technology') {
                            ...
                            <div key={sub.name} className='relative group'>
                              {sub.submenu ? (
                                <>
                                  ...
                                  <div className='absolute top-0 left-full w-56 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200/50 py-2 z-30 hidden group-hover:block group-focus-within:block'>
            ...
            <div className='flex items-center space-x-4 flex-shrink-0'>
              {isAuthenticated ? (
                <div className='relative' ref={userDropdownRef}>
                  ...
                  {/* User Dropdown Menu */}
                  {userDropdownOpen && (
                    <div className='absolute right-0 mt-2 w-56 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200/50 py-2 z-30'>
                      {/* User Info Header */}
