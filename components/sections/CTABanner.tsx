      ...
      <div className='container'>
        <div className='text-center max-w-4xl mx-auto'>
          ...
          <p className='text-xl text-white mb-8 leading-relaxed drop-shadow-lg'>
            Join us in revolutionizing Iraq's energy landscape with clean,
            continuous power. Whether you're interested in our technology,
            projects, or partnership opportunities, we'd love to hear from you.
          </p>
          ...
          <div className='mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
            <div>
              ...
              <h3 className='font-semibold mb-2 text-white drop-shadow-lg'>
                Email Us
              </h3>
              <p className='text-white drop-shadow-lg'>
                <a href='mailto:info@deepengineering.co' className='underline'>
            ...
            <div>
              ...
              <p className='text-white drop-shadow-lg'>
                Roya Tower A 1-14, Erbil-44001, Iraq (HQ)
              </p>
            </div>
            ...
            <div>
              ...
              <p className='text-white drop-shadow-lg'>
                <a
                  href='tel:+9647504663879'
                  className='underline block min-w-[44px] min-h-[44px] inline-block text-center'
                >
                  +964 750 466 3879
                </a>
              </p>
