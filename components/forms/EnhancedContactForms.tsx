...
export default function EnhancedContactForms() {
  ...
  const validateForm = (): boolean => {
    ...
    if (activeForm === 'technical') {
      if (!formData.technicalArea)
        newErrors.technicalArea = 'Technical area is required';
    }
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            ...
            <div>
              ...
              >
                ...
                <option value='direct-investment'>
                ...
                <option value='equity-participation'>
    ...
    <div className='bg-white rounded-lg shadow-lg p-8'>
      ...
      <form onSubmit={handleSubmit} className='space-y-6'>
        ...
        <div>
          ...
          />
          {errors.message && (
            <p className='text-red-500 text-base mt-1'>{errors.message}</p>
          )}
        </div>
