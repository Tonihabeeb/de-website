    ...
    setTimeout(() => {
      ...
      setAnalysis({
        ...
        preview: {
          ...
          description: seoData.description || 'Page description will appear here...'
        }
      });
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-50">
          <div className="text-sm text-gray-600 mb-1">{analysis.preview.url}</div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex justify-between mt-1">
              ...
              <p className="text-xs text-gray-400">
                {seoData.title.length >= 30 && seoData.title.length <= 60 ? '✅ Optimal' : '⚠️ Adjust length'}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex justify-between mt-1">
              ...
              <p className="text-xs text-gray-400">
                {seoData.description.length >= 120 && seoData.description.length <= 160 ? '✅ Optimal' : '⚠️ Adjust length'}
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Issues */}
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Issues to Fix</h3>
          {loading ? (
