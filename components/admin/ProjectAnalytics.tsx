...
import { TrendingUp, Users, Calendar, Target, Activity, Eye, Download, Share2 } from 'lucide-react';
  ...
  const fetchProjectAnalytics = async () => {
    try {
      ...
      const mockAnalytics: ProjectAnalytics = {
        ...
        team_performance: [
          { member: 'John Doe', tasks_completed: 15, hours_logged: 120, efficiency: 95 },
          { member: 'Jane Smith', tasks_completed: 12, hours_logged: 98, efficiency: 88 },
          { member: 'Mike Johnson', tasks_completed: 18, hours_logged: 145, efficiency: 92 },
        ],
      };
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-blue-50 p-4 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-900">{analytics.overview.total_views.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-900">{formatTime(analytics.overview.avg_time_on_page)}</p>
              </div>
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-2xl font-bold ${getPerformanceColor(analytics.performance_metrics.completion_rate)}`}>
            ...
            <div className="mt-2 text-xs text-purple-600">
              {analytics.performance_metrics.on_time_delivery ? 'On track' : 'Behind schedule'}
            </div>
          </div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-orange-600 font-medium">Budget Used</p>
                <p className="text-2xl font-bold text-orange-900">{analytics.performance_metrics.budget_utilization}%</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h4 className="text-sm font-medium text-gray-900 mb-4">Engagement Timeline</h4>
          ...
          {/* Milestone Progress */}
          <div className="bg-gray-50 p-4 rounded-lg">
            <h4 className="text-sm font-medium text-gray-900 mb-4">Milestone Progress</h4>
            <ResponsiveContainer width="100%" height={200}>
              <PieChart>
                <Pie
                  data={milestoneData}
        ...
        {/* Team Performance */}
        <div className="bg-gray-50 p-4 rounded-lg">
          <h4 className="text-sm font-medium text-gray-900 mb-4">Team Performance</h4>
              ...
              <div key={index} className="flex items-center justify-between p-3 bg-white rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{member.tasks_completed} tasks completed</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 text-sm">
                  <span className="text-gray-600">{member.hours_logged}h logged</span>
