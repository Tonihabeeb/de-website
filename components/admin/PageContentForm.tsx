          ...
          <div className='space-y-6'>
            ...
            <div className='bg-white border border-gray-200 rounded-lg p-4'>
              ...
              <div className="mt-3 space-y-1 text-xs text-white">
                ...
                <div className='flex items-center'>
                  <div
                    className={`w-2 h-2 rounded-full mr-2 ${formData.title.length >= 30 && formData.title.length <= 60 ? 'bg-green-500' : 'bg-gray-300'}`}
                  ></div>
                  Title length optimal
                </div>
                <div className='flex items-center'>
                  <div
                    className={`w-2 h-2 rounded-full mr-2 ${formData.meta_description.length > 0 ? 'bg-green-500' : 'bg-gray-300'}`}
                  ></div>
                  Meta description
                </div>
                <div className='flex items-center'>
                  <div
                    className={`w-2 h-2 rounded-full mr-2 ${formData.meta_description.length >= 120 && formData.meta_description.length <= 160 ? 'bg-green-500' : 'bg-gray-300'}`}
                  ></div>
                  Description length optimal
                </div>
                <div className='flex items-center'>
                  <div
                    className={`w-2 h-2 rounded-full mr-2 ${formData.meta_keywords.length > 0 ? 'bg-green-500' : 'bg-gray-300'}`}
                  ></div>
                  Keywords added
                </div>
              </div>
