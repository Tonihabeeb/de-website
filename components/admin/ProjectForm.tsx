...
export default function ProjectForm({
  ...
  const [activeTab, setActiveTab] = useState<'details' | 'team' | 'objectives' | 'risks' | 'attachments'>('details');
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            {isEdit ? 'Update project information and settings' : 'Add a new project to your portfolio'}
          </p>
        </div>
