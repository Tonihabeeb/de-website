...
const LivePreview: React.FC<LivePreviewProps> = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 bg-black bg-opacity-75 flex items-center justify-center ${className}`}
    >
      <div
          ...
          <div className='h-full flex items-center justify-center'>
            <div
              ...
              style={{
                ...
                height:
                  deviceType !== 'desktop' ? currentConfig.height : '100%',
                maxWidth:
                  deviceType !== 'desktop' ? currentConfig.width : 'none',
                maxHeight:
                  deviceType !== 'desktop' ? currentConfig.height : 'none',
              }}
            >
              {/* Device Frame */}
              {deviceType === 'mobile' && (
        ...
        <div className='p-4 border-t border-gray-200 bg-gray-50'>
          <div className="flex items-center justify-between text-sm text-white">
            <div className='flex items-center space-x-4'>
              ...
              <span>
                Size: {currentConfig.width} × {currentConfig.height}
              </span>
            </div>
            <div className='flex items-center space-x-2'>
