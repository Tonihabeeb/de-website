...
export default function DocumentViewer({ doc = placeholderDoc }: { doc?: DocumentMeta }) {
  return (
    <div className="w-full max-w-2xl mx-auto bg-white border rounded-lg shadow p-6">
      <div className="flex items-center gap-4 mb-4">
        ...
        {doc.type === 'image' && <FileImage className="w-10 h-10 text-blue-600" />}
        {doc.type === 'text' && <FileText className="w-10 h-10 text-green-600" />}
        <div>
