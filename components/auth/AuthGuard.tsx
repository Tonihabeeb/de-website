...
export default function AuthGuard({ 
  ...
  }, [isAuthenticated, isLoading, user, requiredRoles, hasAnyRole, router, pathname, redirectTo]);
...
export function UserGuard({ children, fallback }: { children: React.ReactNode; fallback?: React.ReactNode }) {
  return (
    <AuthGuard requiredRoles={['user', 'admin', 'editor', 'viewer']} fallback={fallback}>
      {children}
    </AuthGuard>
  );
}

export function EditorGuard({ children, fallback }: { children: React.ReactNode; fallback?: React.ReactNode }) {
  return (
