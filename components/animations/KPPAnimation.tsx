  ...
  if (shouldReduceMotion) {
    return (
      <div className={className} style={{ minHeight: 320 }}>
        ...
        <div className="text-center mt-2 text-base font-semibold text-gray-700">Floater (Animation Reduced)</div>
      </div>
    );
  }
    ...
    <div className={`relative w-full max-w-4xl mx-auto ${className}`}>
      ...
      <div className="relative bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h3 className="text-2xl font-bold text-primary mb-2">KPP Animation</h3>
            <p className="text-gray-600">Watch the complete energy generation cycle</p>
          </div>
