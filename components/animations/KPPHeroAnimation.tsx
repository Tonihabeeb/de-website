  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 600" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Energy Flow Path 1 */}
        <path d="M 200 300 Q 400 200 600 300 T 1000 300" stroke="url(#energyFlow)" strokeWidth="2" fill="none" opacity="0.6">
          <animate attributeName="stroke-dasharray" values="0,1000;500,500;1000,0" dur="4s" repeatCount="indefinite" />
        </path>
        
        {/* Energy Flow Path 2 */}
        <path d="M 400 100 Q 600 200 800 100 T 1200 100" stroke="url(#energyFlow)" strokeWidth="1.5" fill="none" opacity="0.4">
          <animate attributeName="stroke-dasharray" values="0,800;400,400;800,0" dur="5s" repeatCount="indefinite" />
        </path>
        
        {/* Energy Flow Path 3 */}
        <path d="M 300 500 Q 500 400 700 500 T 1100 500" stroke="url(#energyFlow)" strokeWidth="1.5" fill="none" opacity="0.4">
