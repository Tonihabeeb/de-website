  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-primary mb-4">Energy Cost Calculator</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent mobile-input touch-target"
            placeholder="1000"
            min="1"
          />
        </div>
      ...
      <div className="text-center mb-8">
        <button
          ...
          className="bg-primary text-white px-8 py-4 rounded-lg font-semibold hover:bg-primary-dark transition-colors duration-200 mobile-button touch-target w-full md:w-auto"
        >
          Calculate Costs
        </button>
      </div>
      ...
      {results && (
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 md:p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Annual Energy Costs</h3>
          ...
          <div className="bg-gray-50 rounded-lg p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Annual Savings vs Diesel</div>
              </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Cost Comparison</h3>
            <div className="space-y-4">
              {[
                { name: 'KPP Technology', cost: results.kppCost, color: 'bg-green-500' },
                { name: 'Solar PV', cost: results.solarCost, color: 'bg-yellow-500' },
                { name: 'Natural Gas', cost: results.gasCost, color: 'bg-orange-500' },
                { name: 'Diesel Generators', cost: results.dieselCost, color: 'bg-red-500' }
              ].map((tech, index) => {
                const percentage = (tech.cost / results.dieselCost) * 100;
                return (
                  <div key={index} className="flex items-center gap-4">
                    <span className="w-32 text-sm font-medium text-gray-700">{tech.name}</span>
          ...
          <div className="text-center bg-primary text-white rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-2">Ready to Save on Energy Costs?</h3>
            <p className="mb-4">
              Based on your calculations, you could save {formatCurrency(results.kppSavings)} annually 
              by switching to KPP technology.
            </p>
      ...
      <div className="mt-8 p-4 bg-blue-50 rounded-lg">
        <h4 className="font-semibold text-blue-800 mb-2">Calculation Assumptions</h4>
        <ul className="text-sm text-blue-700 space-y-1">
          ...
          <li>• Natural Gas LCOE: €80/MWh (includes fuel and infrastructure)</li>
