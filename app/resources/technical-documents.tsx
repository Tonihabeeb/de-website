    ...
    <div>
      ...
      <section className="section-padding bg-white">
        <div className="container">
          ...
          <p className="text-gray-text mb-8 max-w-2xl">Browse and download technical specifications, engineering drawings, and performance data for the Kinetic Power Plant and its components.</p>
