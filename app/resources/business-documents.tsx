    ...
    <div>
      ...
      <section className="section-padding bg-white">
        <div className="container">
          ...
          <p className="text-gray-text mb-8 max-w-2xl">Browse and download business plans, executive summaries, financial projections, and feasibility studies for Deep Engineering projects.</p>
