...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'KPP Technical Specifications - Deep Engineering',
    description: 'Comprehensive technical specifications for Kinetic Power Plant (KPP) technology.',
      ...
      <section className="section-padding bg-white">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-primary mb-8 text-center">Generator Specifications</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Power Output</h3>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Physical Dimensions</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Environmental</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between">
            ...
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-primary mb-8 text-center">Air Compressor System</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Compression Parameters</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between">
            ...
            {/* Water Consumption */}
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-primary mb-8 text-center">Water Consumption & Management</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Initial Fill</h3>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-primary mb-2">30 m³</div>
                    <p className="text-gray-600">Initial water requirement for system startup</p>
                  </div>
                </div>

                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Annual Consumption</h3>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-primary mb-2">&lt;5%</div>
                    <p className="text-gray-600">Annual water loss through evaporation</p>
                  </div>
                </div>

                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Water Quality</h3>
            ...
            {/* Performance Metrics */}
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-primary mb-8 text-center">Performance Metrics</h2>
            ...
            <div className="bg-gray-50 rounded-lg p-8 text-center">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Download Technical Documentation</h2>
              <p className="text-gray-600 mb-6">
                Access detailed technical specifications, installation guides, and maintenance manuals.
              </p>
      ...
      <section className="section-padding bg-primary text-white">
        <div className="container text-center">
          ...
          <p className="text-xl text-white mb-8 max-w-3xl mx-auto">
            Contact our technical team for detailed specifications, custom solutions, and implementation support.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="/contact"
          ...
          __html: JSON.stringify({
            ...
            about: [
              ...
              },
              {
                ...
                description: '10 bar operating pressure with 1.2-1.5 m³/min flow rate'
              }
            ],
            offers: {
              '@type': 'Offer',
