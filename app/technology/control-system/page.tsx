...
export const metadata: Metadata = {
  ...
  description:
    'Explore the advanced control system that manages and optimizes KPP technology operations. Learn about automation, monitoring, and intelligent power management.',
  keywords:
    'KPP control system, intelligent power management, automation, monitoring, renewable energy control, sustainable power management',
  openGraph: {
    title: 'KPP Control System - Intelligent Power Management',
    description:
      'Explore the advanced control system that manages and optimizes KPP technology operations. Learn about automation, monitoring, and intelligent power management.',
...
const controlFeatures = [
  {
    ...
    description:
      'Advanced AI algorithms automatically optimize system performance and efficiency in real-time.',
    icon: <Brain className='w-8 h-8' />,
  },
  {
    title: 'Real-Time Monitoring',
    description:
      'Comprehensive monitoring systems track all system parameters and performance metrics.',
    icon: <Monitor className='w-8 h-8' />,
  },
  {
    title: 'Predictive Maintenance',
    description:
      'AI-powered analytics predict maintenance needs and prevent system downtime.',
    icon: <TrendingUp className='w-8 h-8' />,
  },
  {
    title: 'Grid Integration',
    description:
      'Seamless integration with power grids ensures optimal energy distribution and stability.',
    icon: <Zap className='w-8 h-8' />,
  },
  {
    title: 'Safety Systems',
    description:
      'Multiple safety protocols and emergency shutdown systems ensure operational safety.',
    icon: <Shield className='w-8 h-8' />,
  },
  {
    title: 'Remote Control',
    description:
      'Advanced remote monitoring and control capabilities for unmanned operation.',
    ...
    specs: [
      {
        ...
        value: 'Multi-Core CPU',
        description: 'High-performance computing platform',
      },
      {
        name: 'Memory',
        value: '16-64 GB RAM',
        description: 'Expandable memory for complex operations',
      },
      {
        name: 'Storage',
        value: '1-10 TB SSD',
        description: 'High-speed data storage and logging',
      },
      {
        name: 'Network',
        value: 'Gigabit Ethernet',
        description: 'High-speed communication network',
      },
    ],
  },
  {
    ...
    specs: [
      {
        name: 'Response Time',
        value: '< 100ms',
        description: 'Rapid system response capability',
      },
      {
        name: 'Uptime',
        value: '99.9%',
      ...
      },
      {
        name: 'Data Accuracy',
        value: '99.99%',
        description: 'Precise measurement and control',
      },
      {
        name: 'Scalability',
        value: 'Unlimited',
        description: 'Modular expansion capability',
      },
    ],
  },
  {
    ...
    specs: [
      {
        ...
        value: 'Linux/Windows',
        description: 'Robust operating system platform',
      },
      {
...
const controlFunctions = [
  {
    ...
    description:
      'Continuously monitors and adjusts system parameters for maximum efficiency and performance.',
    icon: <TrendingUp className='w-6 h-6' />,
  },
  {
    title: 'Load Management',
    description:
      'Intelligently manages power output based on demand and grid requirements.',
    icon: <Zap className='w-6 h-6' />,
  },
  {
    title: 'Fault Detection',
    description:
      'Advanced diagnostic systems identify and report potential issues before they cause problems.',
    icon: <Shield className='w-6 h-6' />,
  },
  {
    title: 'Data Analytics',
    description:
      'Comprehensive data collection and analysis for performance optimization and reporting.',
        ...
        <div className='container'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl text-white font-semibold leading-relaxed'>
              Intelligent power management technology that optimizes KPP
              operations through advanced automation, real-time monitoring, and
