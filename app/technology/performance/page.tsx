...
export const metadata: Metadata = {
  ...
  description:
    'Explore the performance metrics and technical specifications of the Kinetic Power Plant (KPP) technology. Discover efficiency, capacity, environmental impact, and operational data.',
  keywords:
    'KPP performance, kinetic power plant specifications, fuel-free energy efficiency, renewable energy metrics, KPP technical data, power generation performance',
  openGraph: {
    title:
      'KPP Performance & Specifications - Technical Excellence in Renewable Energy',
    description:
      'Explore the performance metrics and technical specifications of the Kinetic Power Plant (KPP) technology. Discover efficiency, capacity, environmental impact, and operational data.',
    ...
    metrics: [
      {
        name: 'Output Options',
        value: '1 MW & 5 MW',
        description: 'Module options available',
      },
      {
        name: 'Availability',
        value: '100%',
      ...
      },
      {
        ...
        value: '95%',
        description: 'Actual vs. theoretical maximum output',
      },
    ],
  },
  {
    ...
    metrics: [
      {
        ...
        value: '85-90%',
        description: 'Total system efficiency',
      },
      {
        name: 'Generator Efficiency',
        value: '95%',
        description: '500 kW generator at 375 RPM',
      },
      {
        name: 'Transmission Efficiency',
        value: '98%',
        description: 'Mechanical transmission efficiency',
      },
      {
        name: 'Control System',
        value: '99.9%',
        description: 'SCADA system reliability',
      },
    ],
  },
  {
    ...
    metrics: [
      ...
      },
      {
        name: 'NOx Emissions',
        value: '0 mg/kWh',
        description: 'Zero nitrogen oxide emissions',
      },
      {
        name: 'Water Usage',
        value: '<5% recirculation',
        description: 'Minimal water needs, periodic top-up',
      },
      {
        name: 'Land Footprint',
        value: '~300 m²/MW',
        description: 'Compact design vs. thousands for other sources',
      },
    ],
  },
];
...
const environmentalBenefits = [
  {
    ...
    description:
      'KPP technology produces no CO2, NOx, or particulate emissions during operation.',
    impact:
      'Eliminates air pollution and contributes to climate change mitigation.',
    icon: <Leaf className='w-8 h-8' />,
  },
  {
    title: 'No Fuel Consumption',
    description:
      'Operates entirely on kinetic energy, eliminating fuel extraction and transportation.',
  ...
  },
  {
    ...
    description:
      'Compact design requires significantly less land than traditional power plants.',
  ...
  },
  {
    ...
    description:
      "Unlike thermal power plants, KPP technology doesn't require water for cooling.",
        ...
        <div className='container'>
          <div className='text-center mb-8'>
            ...
            <p className='text-xl text-white max-w-3xl mx-auto'>
              Learn more about how KPP technology works and explore its
              components.
            </p>
          </div>
