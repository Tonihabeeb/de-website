...
const toc = [
  { id: 'water-tank', label: 'Water Tank (Shaft)', icon: <Droplets className="w-6 h-6" /> },
  { id: 'floaters', label: 'Floaters (Buoyancy Bodies)', icon: <ArrowDownCircle className="w-6 h-6" /> },
  { id: 'chain', label: 'Endless Chain Conveyor', icon: <Link2 className="w-6 h-6" /> },
  { id: 'drive-shaft', label: 'Drive Shaft & Gearbox', icon: <Gauge className="w-6 h-6" /> },
  { id: 'generator', label: 'Generator', icon: <Zap className="w-6 h-6" /> },
  { id: 'air-system', label: 'Compressed Air System', icon: <Wind className="w-6 h-6" /> },
  { id: 'valve-snorkel', label: 'Valve & Snorkel Mechanism', icon: <Settings className="w-6 h-6" /> },
  { id: 'control-unit', label: 'Control Unit', icon: <Layers className="w-6 h-6" /> },
  { id: 'integration', label: 'System Integration & Operation', icon: <CheckCircle2 className="w-6 h-6" /> },
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Navigate through each core component of the Kinetic Power Plant system to understand its role and specifications.
            </p>
          </div>
                  ...
                  <>
                    ...
                    <div className="bg-white p-6 rounded-lg mb-6">
                      ...
                      <ul className="space-y-2 text-gray-text">
                        <li className="flex items-center">
                          <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
                          Type: Brushless, low-speed permanent magnet synchronous generator
                        </li>
                        <li className="flex items-center">
                          <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
