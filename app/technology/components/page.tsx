          ...
          <div className='max-w-4xl mx-auto'>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
              <div className='bg-white p-6 rounded-lg shadow-sm'>
                ...
                <div className='space-y-3'>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Conversion Efficiency</span>
                    <span className='font-semibold text-green-600'>94.2%</span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Power Output Range</span>
                  ...
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Uptime Reliability</span>
              ...
              <div className='bg-white p-6 rounded-lg shadow-sm'>
                ...
                <div className='space-y-3'>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Rotor Material</span>
                    <span className='font-semibold text-gray-800'>
                      Titanium Alloy
                    </span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Coil Insulation</span>
                    <span className='font-semibold text-gray-800'>
                      Ceramic Composite
                    </span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Bearing Type</span>
                    <span className='font-semibold text-gray-800'>
                      Magnetic Levitation
                    </span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Operating Temperature</span>
                    <span className='font-semibold text-gray-800'>
                      -40°C to +85°C
                    </span>
                  </div>
