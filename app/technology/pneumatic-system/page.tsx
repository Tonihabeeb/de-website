...
export const metadata: Metadata = {
  ...
  description:
    'Explore the advanced pneumatic system that manages air flow and pressure in KPP technology. Learn about efficiency, control, and sustainable air management.',
  keywords:
    'KPP pneumatic system, air management, pressure control, renewable energy pneumatic, sustainable air technology',
  openGraph: {
    title: 'KPP Pneumatic System - Air Management Technology',
    description:
      'Explore the advanced pneumatic system that manages air flow and pressure in KPP technology. Learn about efficiency, control, and sustainable air management.',
...
const pneumaticFeatures = [
  {
    ...
    description:
      'Advanced air flow and pressure control systems ensure optimal operation of the KPP system.',
    icon: <Settings className='w-8 h-8' />,
  },
  {
    title: 'High Efficiency',
    description:
      'Optimized air management minimizes energy losses and maximizes system performance.',
    icon: <TrendingUp className='w-8 h-8' />,
  },
  {
    title: 'Automatic Operation',
    description:
      'Intelligent control systems automatically adjust air flow based on system requirements.',
    icon: <Zap className='w-8 h-8' />,
  },
  {
    title: 'Reliable Performance',
    description:
      'Robust design ensures consistent operation under various environmental conditions.',
    icon: <Shield className='w-8 h-8' />,
  },
  {
    title: 'Modular Design',
    description:
      'Scalable architecture allows for easy maintenance and system expansion.',
    ...
    specs: [
      {
        ...
        value: '2-10 bar',
        description: 'Configurable pressure range',
      },
      {
        name: 'Air Flow Rate',
        value: '100-500 L/min',
        description: 'Variable flow control',
      },
      {
      ...
      },
      {
        ...
        value: '0-95% RH',
        description: 'Non-condensing environment',
      },
    ],
  },
  {
    ...
    specs: [
      {
        ...
        value: '85-92%',
        description: 'Air management efficiency',
      },
      {
        name: 'Response Time',
        value: '< 5 seconds',
        description: 'Rapid pressure adjustment',
      },
      {
        name: 'Pressure Stability',
        value: '±2%',
        description: 'Consistent pressure control',
      },
      {
        name: 'Lifespan',
        value: '15+ years',
  ...
  },
  {
    ...
    specs: [
      ...
      },
      {
        ...
        value: '5-20 kW',
        description: 'Low power requirements',
      },
      {
        ...
        <div className='container'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl text-white font-semibold leading-relaxed'>
              Advanced air management technology that ensures optimal operation
              of KPP systems through precise pressure control and efficient air
              flow management.
            </p>
          </div>
        </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className="text-lg text-white">
                The KPP pneumatic system plays a crucial role in maintaining
                optimal operating conditions throughout the power generation
                process, ensuring efficient energy conversion and system
                reliability.
              </p>
              <p className="text-white">
                Our advanced air management technology provides precise control
                over pressure and flow rates, enabling the KPP system to operate
                at peak efficiency while maintaining safety and reliability
                standards.
              </p>
      ...
      <section className='section-padding bg-gray-light'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className="text-lg text-white">
              The KPP pneumatic system incorporates advanced technology to
              ensure reliable, efficient, and precise air management throughout
