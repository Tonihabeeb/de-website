...
export const metadata: Metadata = {
  ...
  description:
    'Explore the innovative conveyor chain technology that transfers kinetic energy in KPP systems. Learn about design, efficiency, and reliable energy transmission.',
  keywords:
    'KPP conveyor chain, kinetic energy transfer, energy transmission system, renewable energy chain, sustainable power transmission',
  openGraph: {
    title: 'KPP Conveyor Chain - Kinetic Energy Transfer System',
    description:
      'Explore the innovative conveyor chain technology that transfers kinetic energy in KPP systems. Learn about design, efficiency, and reliable energy transmission.',
...
const chainFeatures = [
  {
    title: 'High Strength',
    description:
      'Advanced materials and engineering ensure maximum load capacity and durability under continuous operation.',
    icon: <Shield className='w-8 h-8' />,
  },
  {
    title: 'Low Friction',
    description:
      'Precision-engineered components minimize energy losses during kinetic energy transmission.',
    icon: <TrendingUp className='w-8 h-8' />,
  },
  {
    title: 'Continuous Operation',
    description:
      '24/7 operation capability with automatic tensioning and alignment systems.',
    icon: <Zap className='w-8 h-8' />,
  },
  {
    title: 'Modular Design',
    description:
      'Scalable architecture allows for easy maintenance and capacity expansion.',
    icon: <Settings className='w-8 h-8' />,
  },
  {
    title: 'Precision Control',
    description:
      'Advanced control systems ensure optimal speed and tension for maximum efficiency.',
    icon: <Cog className='w-8 h-8' />,
  },
  {
    title: 'Long Lifespan',
    description:
      'Corrosion-resistant materials and protective coatings ensure extended operational life.',
    ...
    specs: [
      {
        ...
        description: 'Corrosion-resistant, high-strength alloy',
      },
      {
        name: 'Chain Pitch',
        value: '50-100 mm',
      ...
      },
      {
        name: 'Breaking Load',
        value: '500-2000 kN',
        description: 'High safety factor for reliability',
      },
      {
        name: 'Weight',
        value: '10-50 kg/m',
        description: 'Optimized for strength-to-weight ratio',
      },
    ],
  },
  {
    ...
    specs: [
      {
        ...
        value: '92-96%',
        description: 'Kinetic energy transfer efficiency',
      },
      {
        name: 'Operating Speed',
        value: '0.5-2.0 m/s',
        description: 'Variable speed control capability',
      },
      {
        name: 'Tension Force',
        value: '100-500 kN',
        description: 'Automatic tensioning system',
      },
      {
        name: 'Lifespan',
        value: '20+ years',
  ...
  },
  {
    ...
    specs: [
      ...
      },
      {
        name: 'Noise Level',
        value: '< 45 dB',
        description: 'Quiet operation for various environments',
      },
    ],
  },
];
        ...
        <div className='container'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl text-white font-semibold leading-relaxed'>
              Advanced kinetic energy transfer system that efficiently transmits
              power from buoyancy forces to electrical generation with minimal
              energy losses.
            </p>
          </div>
        </div>
