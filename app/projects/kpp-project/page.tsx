...
export const metadata: Metadata = {
  ...
  description:
    "Explore the revolutionary Kinetic Power Plant (KPP) project - Iraq's flagship renewable energy initiative. Discover progress, achievements, and the path to sustainable energy independence.",
  keywords:
    'KPP project, kinetic power plant Iraq, renewable energy project, sustainable energy Iraq, project showcase, energy independence',
  openGraph: {
    title: 'KPP Project Showcase - Revolutionary Renewable Energy in Iraq',
    description:
      "Explore the revolutionary Kinetic Power Plant (KPP) project - Iraq's flagship renewable energy initiative.",
...
const projectMilestones = [
  {
    ...
    description:
      'Project conceptualization and initial feasibility studies completed',
    status: 'completed',
  ...
  },
  {
    ...
    description:
      'KPP technology validated by international certification bodies (TÜV/SGS/DEKRA)',
    status: 'completed',
  ...
  },
  {
    ...
    description:
      'Received official government approval and regulatory clearances',
    status: 'completed',
    icon: <CheckCircle2 className='w-6 h-6' />,
  },
  {
    ...
    description:
      'Strategic site identification and environmental impact assessment',
    status: 'completed',
...
const keyAchievements = [
  {
    ...
    description:
      'KPP technology validated by TÜV, SGS, and DEKRA - world-leading certification bodies',
  ...
  },
  {
    ...
    description:
      'Full government approval and regulatory clearance for project implementation',
  ...
  },
  {
    ...
    description:
      'Zero-emission technology with comprehensive environmental impact assessment',
  ...
  },
  {
    ...
    description:
      'Projected to create 500+ direct jobs and 2000+ indirect employment opportunities',
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className="text-white">
                ...
                significant economic opportunities and reducing carbon
                emissions.
              </p>
        ...
        <div className='container'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            {keyAchievements.map((achievement, index) => (
              <div
                key={index}
                className='text-center bg-gray-light p-6 rounded-lg'
              >
      ...
      <section className='section-padding bg-primary text-white'>
        <div className='container text-center'>
          ...
          <p className='text-lg mb-8 max-w-3xl mx-auto'>
            The KPP project represents the future of sustainable energy in Iraq
            and beyond. Stay updated on our progress and learn how you can be
