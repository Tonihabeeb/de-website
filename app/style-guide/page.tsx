        ...
        <section className='mb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {colors.map(color => (
              ...
              >
                <div
                  className={`w-full h-20 rounded-lg mb-4 ${color.class} flex items-center justify-center`}
                >
            ...
            <div className='space-y-6'>
              {typography.map(type => (
                ...
                >
                  ...
                  <div className={`${type.class} font-serif text-primary`}>
                    {type.text}
                  </div>
                </div>
              ))}
          ...
          <div className='bg-white rounded-lg p-8 shadow-sm'>
            <div className='space-y-8'>
              ...
              <div>
                ...
                <div className='flex flex-wrap gap-4'>
                  <button className='btn-primary min-w-[44px] min-h-[44px]'>
                    CSS Primary
                  </button>
                  <button className='btn-secondary min-w-[44px] min-h-[44px]'>
                    CSS Secondary
                  </button>
                </div>
              </div>
          ...
          <div className='bg-white rounded-lg p-8 shadow-sm'>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
              {icons.map(iconItem => (
                <div
                  key={iconItem.name}
                  className='text-center p-4 border border-gray-100 rounded-lg hover:border-primary transition-colors'
                >
