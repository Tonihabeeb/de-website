...
import { BarChart3, TrendingUp, Users, Leaf, Clock, DollarSign } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Welcome to your Deep Engineering dashboard</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/dashboard/project-progress" className="group">
              <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm">Track project milestones and timelines</p>
              </div>
            </Link>
            ...
            <Link href="/dashboard/financial" className="group">
              <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm">Monitor financial metrics and performance</p>
              </div>
            </Link>
            ...
            <Link href="/dashboard/stakeholders" className="group">
              <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Stakeholders</h3>
                <p className="text-gray-600 text-sm">Manage stakeholder relationships</p>
              </div>
            </Link>
            ...
            <Link href="/dashboard/environmental" className="group">
              <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Environment Dashboard</h3>
                <p className="text-gray-600 text-sm">Track environmental impact and compliance</p>
              </div>
            </Link>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-600">Project milestone completed</span>
                  <span className="text-xs text-gray-400">2 hours ago</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-sm text-gray-600">Financial report generated</span>
                  <span className="text-xs text-gray-400">1 day ago</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <span className="text-sm text-gray-600">New stakeholder added</span>
