...
import { Globe, Leaf, BarChart3, CheckCircle2, Award, TrendingUp } from 'lucide-react';
          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              <div className="bg-gray-light p-6 rounded-lg text-center">
                ...
                <div className="text-2xl font-bold text-primary">2.5M Tons/Year</div>
              </div>
              <div className="bg-gray-light p-6 rounded-lg text-center">
                <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <div className="text-2xl font-bold text-primary">Zero Consumption</div>
              </div>
              <div className="bg-gray-light p-6 rounded-lg text-center">
                <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center mx-auto mb-3">
              ...
              <div className="bg-gray-light p-6 rounded-lg text-center">
                ...
                <div className="text-2xl font-bold text-primary">TÜV, SGS, DEKRA</div>
              </div>
            </div>
            <div className="bg-gray-light p-8 rounded-lg text-center text-gray-500">
              Impact assessment visualizations and compliance tracking coming soon.
            </div>
          </div>
        </section>
      </div>
