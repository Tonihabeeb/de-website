          ...
          <div className='max-w-6xl mx-auto'>
            ...
            <div className='grid lg:grid-cols-3 gap-8'>
              ...
              <div className='bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-lg'>
                ...
                <h3 className='text-2xl font-bold text-primary mb-4'>EPC</h3>
                <p className='text-gray-text mb-6'>
              ...
              <div className='bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-lg'>
                ...
                <h3 className='text-2xl font-bold text-primary mb-4'>O&M</h3>
                <p className='text-gray-text mb-6'>
          ...
          <div className='max-w-4xl mx-auto'>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
              <div className='bg-white p-6 rounded-lg shadow-sm'>
                ...
                <div className='space-y-3'>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Years of Experience</span>
                    <span className='font-semibold text-primary'>15+</span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Projects Completed</span>
                    <span className='font-semibold text-primary'>50+</span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Countries Served</span>
                    <span className='font-semibold text-primary'>25+</span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Team Members</span>
              ...
              <div className='bg-white p-6 rounded-lg shadow-sm'>
                ...
                <div className='space-y-3'>
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Uptime Guarantee</span>
                  ...
                  <div className='flex justify-between items-center'>
                    <span className='text-gray-text'>Customer Satisfaction</span>
      ...
      <section className='section-padding bg-white'>
        <div className='container'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-gray-text leading-relaxed mb-12'>
