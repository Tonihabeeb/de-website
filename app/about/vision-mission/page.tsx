...
export const metadata: Metadata = {
  ...
  description:
    "Deep Engineering's vision and mission - driving innovation in sustainable energy solutions for a cleaner, more efficient future.",
  keywords:
    'vision, mission, Deep Engineering, sustainable energy, innovation, future, goals',
};
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl mb-4 text-white font-semibold'>
              Shaping the future of sustainable energy through innovation and
              purpose
            </p>
            <p className='text-lg text-white'>
              Our vision and mission guide everything we do, from the
              technologies we develop to the partnerships we forge, all in
              pursuit of a cleaner, more sustainable world.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl leading-relaxed mb-8'>
              We promise to remain steadfast in our commitment to
              sustainability, innovation, and positive impact. Every day, we
              work toward our vision of a cleaner, more sustainable world,
              knowing that the future depends on the actions we take today.
            </p>
            <div className='grid md:grid-cols-3 gap-8 mt-12'>
              <div className='text-center'>
                ...
                <p className='text-white/80'>
                  Protecting and preserving the environment for future
                  generations.
                </p>
              </div>
              <div className='text-center'>
                ...
                <p className='text-white/80'>
                  Creating opportunities and improving lives through sustainable
                  energy.
                </p>
              </div>
              <div className='text-center'>
