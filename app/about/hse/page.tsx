...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive Health, Safety, and Environment framework ensuring zero harm to people and planet through KPP technology and responsible practices.',
  keywords:
    'HSE, health, safety, environment, workplace safety, Deep Engineering, KPP, zero emissions, occupational health',
  openGraph: {
    title: 'Health, Safety & Environment - Deep Engineering',
    description:
      'Comprehensive HSE framework ensuring zero harm to people and planet.',
...
const hseMetrics = [
  {
    ...
    metrics: [
      {
        label: 'Occupational Health Score',
        value: '98%',
    ...
    metrics: [
      {
        ...
        value: '2.5M Tons/Year',
        icon: <Leaf className='w-5 h-5' />,
      },
      {
        label: 'Zero Environmental Impact',
        value: '100%',
        icon: <Globe className='w-5 h-5' />,
      },
      {
        label: 'Water Conservation',
        value: 'Zero Consumption',
...
const complianceDocuments = [
  {
    ...
    description:
      'Comprehensive EIA demonstrating zero environmental impact of KPP operations',
    status: 'Approved',
    date: '2023 Q3',
  ...
  },
  {
    ...
    description:
      'ISO 45001 certified occupational health and safety management system',
    status: 'Certified',
    date: '2023 Q2',
        ...
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Deep Engineering's comprehensive Health, Safety, and Environment
              framework ensures the wellbeing of our people and protection of
              our planet through innovative technology and responsible
              practices.
            </p>
          </div>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Comprehensive health monitoring, ergonomic assessments, and
                    wellness programs ensuring optimal employee health and
                    wellbeing.
                  </p>
                </div>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Access to counseling services, stress management programs,
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Proactive health monitoring and early intervention programs
                    to prevent workplace-related health issues.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='bg-orange-50 p-8 rounded-lg border border-orange-200'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Comprehensive safety protocols, continuous training, and
                    monitoring to achieve zero workplace incidents.
                  </p>
                </div>
                <div>
                  <h4 className='font-semibold text-gray-900 mb-2'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Well-trained emergency response teams and clear evacuation
                    procedures for all facilities and operations.
                  </p>
                </div>
                <div>
                  <h4 className='font-semibold text-gray-900 mb-2'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    KPP technology eliminates traditional energy generation
                    safety risks through zero-emission operation.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='bg-green-50 p-8 rounded-lg border border-green-200'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    KPP technology operates with zero emissions, zero water
                    consumption, and minimal land footprint.
                  </p>
                </div>
                <div>
                  <h4 className='font-semibold text-gray-900 mb-2'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Each KPP module prevents 2.5 million tons of CO₂ emissions
                    annually, contributing to climate goals.
                  </p>
                </div>
                <div>
                  <h4 className='font-semibold text-gray-900 mb-2'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Revolutionary technology that transforms energy generation
      ...
      <section className='section-padding bg-gray-light'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Quantified performance across health, safety, and environmental
              dimensions, demonstrating our commitment to excellence.
            </p>
          </div>
      ...
      <section className='section-padding bg-white'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Comprehensive safety protocols ensuring zero harm to personnel,
              communities, and the environment throughout all phases of KPP
      ...
      <section className='section-padding bg-gray-light'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Comprehensive analysis demonstrating the KPP project's minimal
              environmental footprint and positive contribution to
      ...
      <section className='section-padding bg-white'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Our commitment to regulatory compliance and international
              standards is demonstrated through comprehensive documentation and
      ...
      <section className='section-padding bg-gray-light'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Comprehensive programs ensuring continuous improvement in health,
              ...
              <div className='space-y-4'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Mandatory safety training for all employees and
                      contractors
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Regular awareness campaigns and best practice sharing
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      KPP-specific safety and operational training
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Monthly emergency response simulations and training
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='space-y-4'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      24/7 monitoring of all critical safety and environmental
                      parameters
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Quarterly safety and environmental compliance audits
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Monthly HSE performance metrics and trend analysis
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className='section-padding bg-primary text-white'>
        <div className='container text-center'>
          ...
          <p className='text-lg mb-8 max-w-3xl mx-auto'>
            ...
            safety, and environmental protection. Our goal is zero harm to
            people and planet through innovative technology and responsible
            practices.
          </p>
          <div className='grid md:grid-cols-3 gap-8 mt-12'>
            <div className='text-center'>
              ...
              <p className='text-white/80'>
                Our ultimate goal is zero workplace injuries and environmental
                incidents.
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-white/80'>
                We continuously improve our HSE performance through innovation
                and best practices.
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-white/80'>
                We engage with employees, communities, and regulators to ensure
