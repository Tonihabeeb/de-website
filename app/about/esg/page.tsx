...
export const metadata: Metadata = {
  ...
  description:
    "Deep Engineering's comprehensive Environmental, Social, and Governance framework - driving sustainable impact through KPP technology and responsible business practices.",
  keywords:
    'ESG, environmental, social, governance, sustainability, Deep Engineering, KPP, renewable energy, carbon neutrality',
  openGraph: {
    title: 'ESG Excellence - Deep Engineering',
    description:
      'Comprehensive Environmental, Social, and Governance framework driving sustainable impact.',
...
const complianceReports = [
  {
    ...
    description:
      'Comprehensive EIA report demonstrating zero environmental impact',
    status: 'Approved',
    date: '2023 Q3',
  ...
  },
  {
    ...
    description:
      'Full compliance with Iraqi energy and environmental regulations',
    status: 'Compliant',
    date: '2023 Q3',
        ...
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              ...
              principles into every aspect of our operations, with the KPP
              project serving as our flagship initiative for sustainable
              development.
            </p>
          </div>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    KPP technology operates with zero emissions, no fuel
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    ...
                    annually, contributing to Iraq's climate goals.
                  </p>
                </div>
                <div>
                  <h4 className='font-semibold text-gray-900 mb-2'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Revolutionary technology that transforms renewable energy
                    generation while protecting natural resources.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='bg-blue-50 p-8 rounded-lg border border-blue-200'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Creating 2,500+ direct and indirect jobs, supporting local
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Providing reliable, affordable energy to Iraqi communities,
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Comprehensive training programs for local workforce in
            ...
            <div className='bg-purple-50 p-8 rounded-lg border border-purple-200'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Compliance with international certification standards (TÜV,
                    SGS, DEKRA) and best practices.
                  </p>
                </div>
                <div>
                  <h4 className='font-semibold text-gray-900 mb-2'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Open communication and regular reporting on ESG performance,
                    progress, and impact.
                  </p>
                </div>
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Upholding highest ethical standards in all business
      ...
      <section className='section-padding bg-gray-light'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Quantified impact of our ESG initiatives through the KPP project
      ...
      <section className='section-padding bg-white'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Comprehensive EIA findings demonstrate the KPP project's minimal
      ...
      <section className='section-padding bg-gray-light'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Our commitment to transparency and regulatory compliance is
              demonstrated through comprehensive reporting and third-party
              validations.
            </p>
          </div>
      ...
      <section className='section-padding bg-white'>
        <div className='container'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-text max-w-3xl mx-auto'>
              Our roadmap for continuous improvement and sustainable development
              through 2030.
            </p>
          </div>
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    <h4 className='font-semibold'>
                      KPP Project Implementation
                    </h4>
                    <p className='text-sm text-gray-text'>
                      Complete 500 MW KPP installation and commissioning
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Train 1000+ local workers in renewable energy technology
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Launch 15+ community development and education initiatives
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Establish comprehensive ESG monitoring and reporting
                      system
                    </p>
                  </div>
                </div>
              ...
              <div className='space-y-4'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Deploy 5 GW of KPP capacity across Iraq
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Achieve net-zero carbon emissions for all operations
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Export KPP technology to neighboring countries
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-text'>
                      Set new industry standards for renewable energy ESG
                      practices
                    </p>
                  </div>
                </div>
      ...
      <section className='section-padding bg-primary text-white'>
        <div className='container text-center'>
          ...
          <p className='text-lg mb-8 max-w-3xl mx-auto'>
            ...
            sustainable energy through innovative technology and responsible
            business practices. Learn more about our ESG initiatives.
          </p>
