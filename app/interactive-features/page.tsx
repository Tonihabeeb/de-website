...
export const metadata: Metadata = {
  ...
  description:
    'Explore our interactive tools including energy cost calculator, project tracker, and enhanced contact forms.',
  keywords:
    'interactive features, energy calculator, project tracker, contact forms, KPP tools',
};
      ...
      <section className='section-padding bg-primary text-white'>
        <div className='container text-center'>
          ...
          <p className='text-xl text-white mb-8 max-w-3xl mx-auto'>
            Discover our technology, track project progress, and connect with
            our team to learn more about KPP solutions for Iraq.
          </p>
