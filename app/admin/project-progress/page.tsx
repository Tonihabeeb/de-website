...
export default function ProjectProgressManagement() {
  ...
  const handleDeleteMilestone = async (milestoneId: string) => {
    ...
    try {
      const response = await fetch(`/api/admin/project-progress/milestones/${milestoneId}`, {
        method: 'DELETE'
      });
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Project Progress Management</h1>
            <p className="text-gray-600 mt-1">Manage project milestones, metrics, and activity logs</p>
          </div>
