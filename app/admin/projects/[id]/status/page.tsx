    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Project Status Management</h1>
      ...
      {success && (
        <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <span className="text-green-800">Project status updated successfully!</span>
          </div>
        </div>
      )}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRiskColor(project.risk_level)}`}>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getBudgetColor(project.budget_status)}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      <p>Start: {project.start_date ? new Date(project.start_date).toLocaleDateString() : 'Not set'}</p>
                      <p>End: {project.end_date ? new Date(project.end_date).toLocaleDateString() : 'Not set'}</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      <p>{project.budget_currency} {project.budget?.toLocaleString() || '0'}</p>
                    </div>
                  </div>
                </div>
              </div>
