        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">Manage your website content and users</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mt-4">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-yellow-600">{stats.draftPages} Draft</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mt-4">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-600">{stats.totalProjects - stats.activeProjects} Inactive</span>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-600">Add content to your website</p>
                </div>
              </button>
              ...
              <button className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-600">Start a new KPP project</p>
                </div>
              </button>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow">
              <div className="px-6 py-4 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600">Latest actions across the system</p>
              </div>
              <div className="p-6">
