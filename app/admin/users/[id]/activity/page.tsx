...
export default function UserActivity() {
  ...
  const fetchActivityLogs = async () => {
    try {
      const response = await fetch(`/api/admin/users/${userId}/activity?period=${period}`);
      const data = await response.json();
  ...
  const fetchActivityStats = async () => {
    try {
      const response = await fetch(`/api/admin/users/${userId}/activity/stats?period=${period}`);
      const data = await response.json();
  ...
  const filteredActivityLogs = activityLogs.filter(log => {
    ...
    const matchesResource = !resourceFilter || log.resource_type.toLowerCase().includes(resourceFilter.toLowerCase());
        ...
        <>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{activityStats.total_actions}</p>
                </div>
              ...
              <div className="mt-4">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-green-600">{activityStats.actions_today}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">This Week</span>
                  <span className="font-medium text-blue-600">{activityStats.actions_this_week}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">{activityStats.actions_this_month}</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-bold text-green-600">{activityStats.most_active_day}</p>
                </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(activityStats.actions_by_type).map(([action, count]) => (
            ...
            {filteredActivityLogs.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">
                  {actionFilter || resourceFilter ? 'Try adjusting your filters.' : 'No activity recorded for this period.'}
                </p>
              </div>
            )}
          </div>
