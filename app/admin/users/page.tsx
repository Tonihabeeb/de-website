...
export default function UserManagement() {
  ...
  const handleBulkRoleUpdate = async (roleId: string) => {
    if (selectedUsers.length === 0) return;
    if (!confirm(`Are you sure you want to assign this role to ${selectedUsers.length} users?`)) return;
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="mt-4">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-red-600">{userStats.inactive}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{userStats.superAdmin}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{userStats.editor}</p>
            </div>
        ...
        {filteredUsers.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">
              {searchTerm || roleFilter || statusFilter ? 'Try adjusting your search or filters.' : 'Start by creating your first user.'}
            </p>
