    ...
    <div className='p-6'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex items-center space-x-3'>
            <Link
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center transition-colors text-white"
            >
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-6'>
        ...
        <div className='bg-white p-6 rounded-lg shadow'>
          <div className='flex items-center justify-between'>
            <div>
              <p className="text-sm font-medium text-white">Editors</p>
      ...
      {selectedUsers.length > 0 && (
        <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4 text-white">
          <div className='flex items-center justify-between'>
        ...
        {filteredUsers.length === 0 && (
          <div className='text-center py-12'>
            ...
            {!searchTerm && !roleFilter && !statusFilter && (
              <Link
                href='/admin/users/new'
                className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center mx-auto w-fit transition-colors text-white"
              >
                <Plus className='w-4 h-4 mr-2' />
                Create First User
              </Link>
