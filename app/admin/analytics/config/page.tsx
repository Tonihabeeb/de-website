...
export default function AdminAnalyticsConfigPage() {
    ...
    setConfig(prev => ({
      ...
      integrations: {
        ...
        customEvents: {
          ...
          events: prev.integrations.customEvents.events.filter(
            e => e.id !== eventId
          ),
        },
      },
  ...
  const handleAddRecipient = () => {
    if (
      newRecipient &&
      !config.notifications.recipients.includes(newRecipient)
    ) {
      setConfig(prev => ({
        ...prev,
        notifications: {
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          <div className='bg-white rounded-lg shadow-sm border border-gray-200'>
            ...
            <div className='p-6 space-y-4'>
              ...
              <label className='flex items-center justify-between'>
                <div>
                  <span className='font-medium text-primary'>Demographics</span>
              ...
              <label className='flex items-center justify-between'>
                <div>
                  <span className='font-medium text-primary'>Interests</span>
          ...
          <div className='space-y-4'>
            <div>
              ...
              <input
                ...
                onChange={e =>
                  setEditingEvent((prev: CustomEvent | null) =>
