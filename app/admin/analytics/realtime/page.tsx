...
export default function RealTimeAnalyticsPage() {
  ...
  const mockRealTimeData: RealTimeData = {
    ...
    topPages: [
      ...
      { path: '/technology', title: 'Technology', views: 2340, uniqueViews: 1890 },
          ...
          userActivity: [
            {
              ...
              action: ['page_view', 'form_submit', 'download'][Math.floor(Math.random() * 3)],
              page: ['/', '/technology', '/projects', '/about', '/contact'][Math.floor(Math.random() * 5)],
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No real-time data available</h3>
          <p className="text-gray-600">Real-time analytics are not currently available.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="text-3xl font-bold text-gray-900">{realTimeData.activeUsers}</div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="text-3xl font-bold text-gray-900">{realTimeData.pageViews.toLocaleString()}</div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="text-3xl font-bold text-gray-900">{Math.floor(realTimeData.averageSessionDuration / 60)}m</div>
          <div className="text-sm text-gray-500 mt-1">{realTimeData.averageSessionDuration % 60}s</div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="text-3xl font-bold text-gray-900">{realTimeData.bounceRate}%</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-900">Live User Activity</h2>
            <p className="text-gray-600 mt-1">Real-time user actions and page visits</p>
          </div>
          <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-gray-600 mt-1">Live system notifications and warnings</p>
          </div>
          <div className="p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-900">Device Distribution</h2>
            ...
            <div className="space-y-4">
              {realTimeData.deviceStats.map((device, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    {device.device === 'Desktop' && <Monitor className="w-4 h-4 text-blue-500" />}
                    {device.device === 'Mobile' && <Smartphone className="w-4 h-4 text-green-500" />}
                    {device.device === 'Tablet' && <Globe className="w-4 h-4 text-purple-500" />}
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 mt-8">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-1">Real-time system performance indicators</p>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{realTimeData.performanceMetrics.responseTime}ms</div>
              <div className="text-sm text-gray-500">Response Time</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{realTimeData.performanceMetrics.loadTime}s</div>
              <div className="text-sm text-gray-500">Load Time</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{realTimeData.performanceMetrics.errorRate}%</div>
              <div className="text-sm text-gray-500">Error Rate</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{realTimeData.performanceMetrics.uptime}%</div>
