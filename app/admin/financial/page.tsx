...
export default function FinancialManagement() {
  ...
  const [editingMetric, setEditingMetric] = useState<InvestmentMetric | null>(null);
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage financial data, revenue, costs, and investment metrics</p>
          </div>
              ...
              <form onSubmit={handleRevenueSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setRevenueForm({...revenueForm, revenue: parseFloat(e.target.value)})}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    required
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setRevenueForm({...revenueForm, cost: parseFloat(e.target.value)})}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    required
                  />
                </div>
      ...
      {showTransactionForm && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Log Transaction</h3>
      ...
      {showMetricForm && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Add Investment Metric</h3>
              <form onSubmit={handleMetricSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setMetricForm({...metricForm, value: parseFloat(e.target.value)})}
                      className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                      required
                    />
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setMetricForm({...metricForm, target: parseFloat(e.target.value)})}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                <div className="flex justify-end space-x-3 pt-4">
